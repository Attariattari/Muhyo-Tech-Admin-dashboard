...
const BlogTopicPlanSchema = new mongoose.Schema({
  ...
  serviceRelevance: { type: Number, min: 0, max: 1, default: 0, set: (v) => (typeof v === "number" && Number.isFinite(v) ? v : 0) },
  serviceSlug: { type: String, trim: true },
  clusterDepth: { type: Number, min: 0, max: 12, default: 2, set: (v) => (typeof v === "number" && Number.isFinite(v) ? v : 2) },
  clusterStrategy: { type: String, enum: ["dynamic_cluster", "standalone", "trend", "expansion"], default: "dynamic_cluster" },
  opportunityScore: { type: Number, min: 0, max: 100, default: 50, index: true, set: (v) => (typeof v === "number" && Number.isFinite(v) ? v : 50) },
  scoreBreakdown: { type: mongoose.Schema.Types.Mixed, default: {} },
  ...
  cannibalizationRisk: { type: Number, min: 0, max: 100, default: 0, set: (v) => (typeof v === "number" && Number.isFinite(v) ? v : 0) },
  ...
  confidence: { type: Number, min: 0, max: 1, default: 0.9, set: (v) => (typeof v === "number" && Number.isFinite(v) ? v : 0.9) },
